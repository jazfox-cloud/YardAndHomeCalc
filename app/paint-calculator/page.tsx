...
const description =
  "Estimate gallons of paint for walls and rooms by area, doors, windows, coats, coverage per gallon, waste, and cost.";

export const metadata: Metadata = {
  title: "Paint Calculator - Estimate Gallons for Walls and Rooms | Yard & Home Calc",
  description,
...
export default function PaintCalculatorPage() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <CalculatorIntro
        description="Use this paint calculator to estimate wall area, paintable area, gallons to buy, and optional paint cost for a room."
